...
Si vous souhaitez un PC optimiser visant un gain de latence, faites le, mais sachez que c'est à vos risques et périls, que vous risquez à un moment de devoir réinstaller windows, si vous souhaitez avoir une version strip de Windows, je vous conseille de la faire vous même via le logiciel [NTLite](https://www.ntlite.com/).<br/>

Voici ce que je vous conseille sur une nouvelle installation de windows. Ce sont des tweaks qui sont sans dangers pour le pc, que ce soit niveau hardware ou software. Si vous avez une question particulière durant une des étapes, n'hésitez pas à demander sur *[`Discord`](https://discord.gg/sesNRaGEHW)* !<br/>
...
La commande à rentrer dans CMD (en admin) est la suivante 
...
## Désintallation des applications inutiles via [`GeekUnistaller`](https://geekuninstaller.com/)

Une fois que Windows est installé, je vous consseille de supprimer les applications pré-installer que vous **n'utiliserais jamais** tel que OneDrive, Edge, Cortana...( voir selon votre utilisation).
